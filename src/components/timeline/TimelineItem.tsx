...
const TimelineItem: React.FC<TimelineItemProps> = ({
  ...
  <div className="flex">
    <div className="relative flex-row">
      ...
      <div className="absolute top-0 mt-5 size-4 rounded-full bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 shadow">
        <div className="absolute top-0 ml-1 mt-1 size-2 rounded-full bg-gray-50 dark:bg-dark"></div>
      </div>
    </div>
