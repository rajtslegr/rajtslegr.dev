import { IRacingAccountsResponse, IRacingRating } from '@/types/entities';
    ...
    <div className="grid gap-3 sm:grid-cols-2">
      {Object.entries(categoryGroups).map(([category, ratings]) => {
        ...
        return (
          <div
            key={category}
            className="card-hover rounded-md border border-gray-200/30 bg-card-light p-4 dark:border-gray-800/30 dark:bg-card"
          >
            <h3
